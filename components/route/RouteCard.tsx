import { fetchRouteFromGoogle } from '@/utils/googleDirection';
  ...
  return (
    <TouchableWithoutFeedback onPress={() => setMenuVisible(false)}>
      <View style={styles.card}>
          ...
          <View style={styles.mapPreview}>
            <MapView
              ...
              initialRegion={{
                ...
                longitude: pathCoords[0]?.longitude || 126.978,
                latitudeDelta: 0.01,
                longitudeDelta: 0.01,
              }}
            >
        ...
        <TouchableOpacity style={styles.startButton} onPress={() => router.push(`/run?routeId=${route.id}`)}>
